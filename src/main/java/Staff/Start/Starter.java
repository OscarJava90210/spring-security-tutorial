...
import Staff.ServiceRepo.PersonsHolderRepository;
...
public class Starter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PersonListHolder listOfEmployees = PersonsHolderRepository.getListOfEmployees(personsFile);
        /**
          * @method to writeJson
          **/
        File fileToWriteJson = new File("Введи файл или создай");
